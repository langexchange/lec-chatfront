...
const jid = "hello@localhost"
const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2ODc4NzIxMTYsImlhdCI6MTY3Nzg2NzMxNywidW5hbWUiOiJoZWxsbyJ9.qsDnTnOBoESSpU9MwLm7wBcaWd_EF6GRzQvDqwDVX3o"

// Event after converse has loaded
converse.initialize({
  theme: 'langexchange',
  auto_away: 300,
  enable_smacks: true,
